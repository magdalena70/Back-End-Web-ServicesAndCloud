...
namespace BugTracker.Tests
{
    ...
    {
        [TestMethod]
        public void CreateBugWithComments_GetCommentsByBugId_ShouldListCommentsCorrectly()
        {
            ...
            // Act -> find comments by bug Id
            var httpResponse = TestingEngine.HttpClient.GetAsync(
                "/api/bugs/" +
                submittedBug.Id + 
                "/comments").Result;
